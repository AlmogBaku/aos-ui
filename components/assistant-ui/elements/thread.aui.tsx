  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-5 pt-8 md:px-8 md:pt-10",
        ...
        >
          ...
          <div
            ...
            className="mx-auto mb-16 flex w-full max-w-[45rem] flex-col gap-y-8 empty:hidden"
          >
...
const Composer: FC<{ autoFocus: boolean }> = ({ autoFocus }) => {
  ...
  const resumeQueuedLabel = labels.resumeQueued ?? "Resume queued message"
    ...
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
          ...
          <ComposerPrimitive.Queue>
            {() => (
              <div className="flex items-center gap-2 rounded-lg px-2 py-1 text-sm">
                ...
                <AuiIf condition={(s) => !s.thread.isRunning}>
                  <QueueItemPrimitive.Resume
                    render={
                      <Button
                        type="button"
                        variant="ghost"
                        size="sm"
                        aria-label={resumeQueuedLabel}
                      />
                    }
                  >
                    {resumeQueuedLabel}
      ...
      >
        ...
        <ComposerPrimitive.Input
          ...
          className="aui-composer-input max-h-48 min-h-12 w-full resize-none bg-transparent px-2.5 py-1 text-base leading-6 caret-primary outline-none placeholder:text-muted-foreground"
          rows={1}
          autoFocus={autoFocus}
          enterKeyHint="send"
          submitMode="none"
