  ...
  return (
    ...
    >
      {showFill && (
        <>
          ...
          <polygon
            ...
            fill={`url(#${gradientId})`}
            className="animate-in duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] fill-mode-both fade-in motion-reduce:animate-none"
      ...
      <polyline
        ...
        strokeDashoffset={0}
        strokeOpacity={0.2}
        className="opacity-0 motion-safe:animate-in motion-safe:duration-700 motion-safe:ease-out motion-safe:fill-mode-both motion-safe:fade-in"
      ...
      <polyline
        ...
        strokeDashoffset={0}
        strokeOpacity={0.65}
        className="opacity-0 motion-safe:animate-in motion-safe:duration-500 motion-safe:ease-out motion-safe:fill-mode-both motion-safe:fade-in"
