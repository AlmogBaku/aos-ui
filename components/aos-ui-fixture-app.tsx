...
import { fixtureProviderInstructions } from "@/lib/harness/manifests"
import { useFixtureRuntimeBundle } from "@/lib/runtime-adapters/fixture/fixture-runtime"
import { FIXTURE_NOW } from "@/lib/runtime-adapters/fixture/fixture-workspace"
...
export function FixtureAosUiApp({
  ...
  useEffect(() => {
    if (process.env.NEXT_PUBLIC_AOS_UI_E2E !== "1") return
