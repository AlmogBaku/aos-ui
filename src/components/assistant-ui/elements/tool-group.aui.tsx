...
function ToolGroupTrigger({
  ...
  const label = labels.assistant.toolCalls(count)

  return (
    <CollapsibleTrigger
      data-slot="tool-group-trigger"
      className={cn(
        "aui-tool-group-trigger group/trigger origin-start flex items-center gap-2 text-sm transition-[color,scale] active:scale-[0.98]",
    ...
    >
      {active && (
        <LoaderIcon
          ...
          className="aui-tool-group-trigger-loader size-3 shrink-0 animate-spin [animation-duration:0.6s] motion-reduce:animate-none"
        />
      )}
      <span
