...
function ToolFallbackTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-fallback-trigger group/trigger origin-start flex w-fit items-center gap-2 py-1.5 text-sm text-muted-foreground transition-[color,scale] hover:text-foreground active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100",
        className
      )}
      {...props}
    >
