...
vi.mock("@/runtime-adapters/opencode/opencode-runtime-extras", () => ({
  useAosOpenCodeQuestions: useOpenCodeQuestions,
  useAosOpenCodeRuntimeExtras: useOpenCodeRuntimeExtras,
  useAosOpenCodeSession: useOpenCodeSession,
}))
...
describe("OpenCodeQuestionBridge", () => {
  ...
  it("submits provider-native option labels once through the official runtime", async () => {
    ...
    expect(fastOption).toHaveAttribute("type", "button")
