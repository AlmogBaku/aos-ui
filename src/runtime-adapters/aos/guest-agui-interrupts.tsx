...
/**
 * The guest surface still runs one AG-UI thread, so its interrupt projection
 * lives beside the guest composition rather than in the provider-neutral
 * interaction components. The ACP guest lane replaces this file.
 */
