...
export function getWorkspaceCapabilities(
  ...
  return {
    ...
    builderChat: typeof workspace.openAgentBuilder === "function",
    agentDraftDeletion: typeof workspace.deleteAgentDraft === "function",
    agentDraftRetry: typeof workspace.retryAgentDraft === "function",
    agentLifecycle: typeof workspace.subscribeAgentLifecycle === "function",
