...
export function buildAosUiHarnessPrompt(
  ...
  sections.push(
    capabilities.providerTodos
      ...
      : "- Todo controls are unavailable. Plans and prose must not claim to create or update Todos."
  )
  ...
  sections.push(
    capabilities.providerSubagents
      ...
      : "- Subagent delegation is unavailable. Do not invent a delegated run or transcript."
  )
